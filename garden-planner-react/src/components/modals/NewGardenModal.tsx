...
export function NewGardenModal({onClose}:{onClose:()=>void}){
  ...
  return(<O><div className="new-garden-modal">
    ...
    <div className="new-garden-modal__field"><label className="new-garden-modal__label">Garden Name</label><input className="form-input" value={name} onChange={e=>setName(e.target.value)} placeholder="e.g. Summer 2025"/></div>
    <div className="new-garden-modal__field"><label className="new-garden-modal__label">Icon</label>
